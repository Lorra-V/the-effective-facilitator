-- Remainder of 0005: paths.description column + TEF path bodies.
-- Titles and discipline content_md were already applied via service-role API.
-- Run this in the Supabase SQL Editor to finish 0005.
